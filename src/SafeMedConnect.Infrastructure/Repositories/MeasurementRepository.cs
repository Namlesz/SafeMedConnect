...
internal sealed class MeasurementRepositorySimplified<T>(
    MongoContext db,
    ILogger<MeasurementRepositorySimplified<T>> logger
)
    : IMeasurementRepositorySimplified<T> where T : BaseMeasurementEntity
{
